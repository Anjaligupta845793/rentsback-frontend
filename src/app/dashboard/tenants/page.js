              ...
              <div key={key} className="flex items-center gap-4">
                ...
                <label htmlFor={key} className="text-sm">
                  {key === "acceptedTerms"
                    ...
                    : key === "acceptedPrivacy"
                    ? "I consent to storing and using my personal data"
                    : key === "acceptedOffers"
                    ? "I agree to receive communications and offers"
                    : "I am not a citizen of restricted countries"}
                </label>
              </div>
            ))}
          </div>
            ...
            <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
              <DialogTrigger asChild>
                <MotionButton
                  ...
                  disabled={!detailsSubmitted || isLoading}
                >
                  {isLoading ? (
